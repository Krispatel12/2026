...
import { ArrowLeft, Loader2, Building2, Mail, Lock } from "lucide-react";
...
const OrganizationLogin = () => {
    ...
    const handleLogin = async (e?: React.FormEvent) => {
        ...
        try {
            ...
            // Enterprise Login (Organization Context)
        ...
        <div className="min-h-screen w-full flex bg-background text-foreground overflow-hidden selection:bg-primary/30 selection:text-primary-foreground mesh-gradient-bg">
            ...
            <div className="hidden lg:flex flex-col justify-center w-[45%] p-12 relative z-10 h-screen border-r border-white/5 bg-background/30 backdrop-blur-sm">
                ...
                <div className="absolute top-12 left-12 flex items-center gap-3 animate-fade-in-up">
                    ...
                    <span className="text-2xl font-bold tracking-tight text-foreground">Cortexa Hub</span>
                </div>
                ...
                <div className="text-center px-8 animate-slide-up">
                    <h2 className="text-3xl font-black mb-4 tracking-tight">Enterprise Access</h2>
                    <p className="text-muted-foreground font-light leading-relaxed">
                        Authenticate to manage your organization domain and <br /> mission-critical infrastructure.
                    </p>
                </div>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-6 sm:p-12 relative z-10">
                ...
                <div className="w-full max-w-[440px] space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    <div className="space-y-2">
                        <h2 className="text-4xl font-bold tracking-tighter text-white">Enterprise Login</h2>
                    ...
                    >
                        <form onSubmit={handleLogin} className="space-y-6">
                            <div className="space-y-5">
                                <div className="space-y-2">
                                    <Label htmlFor="email" className="text-muted-foreground font-medium text-xs ml-1">Admin Work Email</Label>
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between items-center px-1">
                                        ...
                                        <span className="text-xs font-medium text-primary cursor-pointer hover:text-primary/80 transition-colors">Forgot?</span>
                                    </div>
                                    <MotionInputContainer>
                                        <div className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground">
